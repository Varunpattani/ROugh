...
INSERT INTO SALES_DATA (REGION,PRODUCT,SALES_AMT,YEAR) VALUES 
...
SELECT
	REGION,SUM(SALES_AMT) 
FROM SALES_DATA 
GROUP BY REGION

--2. Display Average Sales Amount by Product
SELECT 
	PRODUCT,AVG(SALES_AMT) 
FROM SALES_DATA 
GROUP BY PRODUCT
